...
public final class ToolBarSimpleBinding implements ViewBinding {
  ...
  private ToolBarSimpleBinding(@NonNull ConstraintLayout rootView, @NonNull TextView toolBarName) {
  ...
  public static ToolBarSimpleBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.tool_bar_simple, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ToolBarSimpleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ToolBarSimpleBinding((ConstraintLayout) rootView, toolBarName);
    }
