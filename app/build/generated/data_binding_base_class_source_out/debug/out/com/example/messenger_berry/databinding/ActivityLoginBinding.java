...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView backToRegistrationTextViewLogin;
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView backToRegistrationTextViewLogin, @NonNull Button loginButtonLogin,
      @NonNull EditText loginEdittextEmail, @NonNull EditText loginEdittextPassword) {
    this.rootView = rootView;
    this.backToRegistrationTextViewLogin = backToRegistrationTextViewLogin;
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.backToRegistration_textView_login;
      TextView backToRegistrationTextViewLogin = ViewBindings.findChildViewById(rootView, id);
      if (backToRegistrationTextViewLogin == null) {
        break missingId;
      }
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, backToRegistrationTextViewLogin,
